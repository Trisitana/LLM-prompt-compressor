...
class L3LoraL3(nn.Module):
    ...
    def forward(self, input_ids, labels):
        ...
        # past_key_values 的维度为: (num_layers, 2, batch_size, num_heads, seq_len, head_dim)
        # layer_key 和 layer_value 的维度为: (batch_size, num_heads, seq_len, head_dim)
        # -self.num_mem: 表示取最后 num_mem 个 token 的 key/value
        # 最终 trimmed_past_key_values 中每个 key/value 的维度为:
        # (batch_size, num_heads, num_mem, head_dim)
