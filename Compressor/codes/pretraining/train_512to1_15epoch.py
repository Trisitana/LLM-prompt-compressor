...
if __name__ == "__main__":
    ...
    train_text_path = os.path.join(base_url,"train_data.txt")
    test_text_path = os.path.join(base_url,"eval_data.txt")
    ...
    save_path = "lora_param_500/lora_param_512to1_15_epoch"
