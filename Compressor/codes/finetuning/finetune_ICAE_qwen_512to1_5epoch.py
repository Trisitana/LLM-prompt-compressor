...
from ICAEQwenQA import ICAEQwenQA
...
class TextDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        target_tokens[self.num_mem+len(q_tokens)-1:self.num_mem+len(q_tokens)-1+len(a_tokens)+1] = torch.cat((a_tokens, torch.tensor([self.tokenizer.eos_token_id])), dim=0)
...
if __name__ == "__main__":
    ...
    # Training parameters
    # ====================
    project_name = "finetune_ICAE_qwen_512"
    ...
    lora_path = "../pretraining/lora_param_500/qwen_ICAE_512to1_3epoch/lora_params.pth"
    ...
    logging_dir = "finetune_ICAE_qwen_512_log"
    num_train_epochs = 5
    ...
    model = ICAEQwenQA(qwen_path=qwen_path,
