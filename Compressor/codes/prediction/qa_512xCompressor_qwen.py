...
if __name__ == "__main__":
    ...
    text_file_path = os.path.join("../finetuning/datasets_cn/split_test.jsonl")

    num_mem = 1
    # root path to save results
    root = f"512QA_qwen/{num_mem}"
    ...
    lora_path_qa = "../finetuning/lora_param_finetune_512/finetune_qwen_512to1_5epoch/lora_params.pth"
    ...
    # load the compression model: qwen-lora + qwen
    model = L3LoraQwen(qwen_path=qwen_path,
                       cache_dir=cache_dir,
    ...
    for batch_texts in data_loader:
        ...
        past_key_values = model.compress(text=batch_texts["context"][0], text_tokens=back_tokens.unsqueeze(0),
                                       output_path=None)
