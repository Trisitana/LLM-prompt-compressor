...
if __name__ == "__main__":
    ...
    generated_token_len_path = root + "/generated_token_length"
    # "regeneration" or "qa"
    mode = "qa"
    ...
    lora_path_regen = ""
    lora_path_qa = "../finetuning/lora_param_finetune_512/finetune_ICAE_qwen_512to1/lora_params.pth"
